...
import theGarageOp8.interfaces.Paintable;
...
public abstract class Car implements Movable, Paintable {
	...
	public Car(Color color, int weight, double speed) {
	...
	public Car(Color color, int weight, double speed, Country country, CarManufacturer manufacturer) {
	...
	public Car(Color color, int weight, double speed, Country country, CarManufacturer manufacturer,String model) {
	...
	public String toString() {
		return "Color= " + color + ", speed= " + ", Country= " + country.name() + ", manufacturer: "
				+ manufacturer.name();
