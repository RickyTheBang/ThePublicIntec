...
public class FamilyCar extends Car{
	...
	private CarType carType = CarType.FAMILY;
 ...
 */
	...
	public FamilyCar(Color color,int weight, double speed,Country country,CarManufacturer manufacturer) {

		super(color,weight,speed,country,manufacturer);
	}
	
	public FamilyCar(Color color,int weight, double speed,Country country,CarManufacturer manufacturer, String model) {

		super(color,weight,speed,country,manufacturer,model);
	}
	
	public FamilyCar(CarManufacturer manufacturer) {
		super(manufacturer);
	}
	...
	public FamilyCar(Color color,int weight, double speed) {
...
public CarType getCarType() {
	...
	public String toString() {
		return "FamilyCar "+  getModel()  +": "+ super.toString() ;
	}
